...
\date{Last Revision:  Mar. 16, 2017} % Delete this line to display the current date


%%% BEGIN DOCUMENT
\begin{document} 
\makepagestyle{plain}
\makeevenfoot{plain}{\textit{Draft}}{\textit{International Tax}}{\textit{3/5/17}}
\makeoddfoot{plain}{\textit{Draft}}{\textit{International Tax}}{\textit{3/5/17}}
	\frontmatter
		\maketitle
			\newpage
\begin{center} 
...
\end{center}
	\newpage
	\input{preface_Jan9_17}
	
\mainmatter
		\input{Introduction_Jan10_17}
		\input{residence_1_Jan9_17}
		\input{residence_2_Jan13_17}
		\input{residence_3_Jan13_17}
		\input{source_IntDiv_Jan17_17}
		\input{source_Services_Jan21_17}
		\input{source_Royalties_Jan21_17}
		\input{source_SaleProperty_Jan27_17}
		\input{tradebusiness_Feb14_17}
		\input{Firpta_Feb22_17}
		\input{EstripLOB_Mar5_17}
		\input{IntTaxtheory_Mar17_17}
		\input{USCit_SpecialRules_Mar24_17}
		\input{FTC_Mar24_17}
		\input{CFC_Apr1_17}
		\input{PFIC}
		\input{FTC_Limit}
